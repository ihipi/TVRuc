...
class Info():
    ...
    def getTitle(self, title):
        ...
        return self.imdb.search_for_title(title)
    ...
    def tvBuscaId(self,id,tvrage=False, thetvdb=True):
        ...
        if tvrage:
            ...
            r= self.tvmazeRequest('/lookup/shows?thetvdb='+str(id))
        return r
...
########################################################
# b = Info()
# print(b.getTitle('fargo'))
# for result in b.getTitle('fargo'):
# #    img = b.imdb.get_title_images(result['imdb_id'])
# #    titol = b.imdb.get_title_by_id(result['imdb_id'])
#     
#     print(result['title'])
